...
<h3 align="left">Research & Technical Interests:</h3>

- Multi-agent systems and path planning
- Computer vision, behavior analysis (DeepLabCut), machine learning (LightGBM)
- Large-scale molecular docking and computational drug design
- Data pipelines & workflow automation (Jenkins)
- Full-stack engineering (Python, C++, web frameworks)
